...
## Acceptance Criteria
- [ ] Images larger than 1920px (either dimension) are resized
- [ ] Aspect ratio is preserved
- [ ] Images smaller than 1920px are not upscaled
- [ ] High-quality resampling filter used (Lanczos)
- [ ] Resized image returned as `image.Image`
